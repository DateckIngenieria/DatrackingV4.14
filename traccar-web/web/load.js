(function () {
    ...
    addStyleFile('https://cdn.traccar.com/js/ol-layerswitcher/3.8.3/'+ 'ol-layerswitcher.css');
    addScriptFile('https://cdn.traccar.com/js/ol-layerswitcher/3.8.3/'+ 'ol-layerswitcher.js');
